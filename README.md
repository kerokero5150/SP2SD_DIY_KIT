...
You can flash your Arduino Nano via ArduinoIDE. Please download and use firmware of ["SmartportSD-1.15" folder](SmartportSD-1.15). If a new folder is created when using the Arduino IDE, please re-insert all the contents of this "SmartportSD-1.15 2" folder into the new folder.<BR>
<BR>
